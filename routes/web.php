...
Route::get('/OBSLive/Bauchbinde',                                [OBSLiveController::class, 'bauchbinde'])       ->name('obsLive.bauchbinde');
Route::get('/OBSLive/Aktuellesrennen',                         [OBSLiveController::class, 'currentRace'])      ->name('obsLive.currentRace');
Route::get('/OBSLive/ErgebnisseUnveroeffentlicht',     [OBSLiveController::class, 'resultall'])             ->name('obsLive.resultall');
